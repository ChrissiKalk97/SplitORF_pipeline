...
packages <- c("seqinr", "ggplot2", "geomtextpath", "tidyr", "stringr", "dplyr", "gridExtra")
...
# library(stringr)
```
This report shows a number of summary statistics of the a result file obtained from the [SplitOrfs](https://github.com/ChrissiKalk97/SplitORF_pipeline.git) software.
