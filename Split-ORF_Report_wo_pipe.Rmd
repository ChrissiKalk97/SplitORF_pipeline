...
## Histogramm of matching ORFs per source transcripts:
...
ggplot(df_expanded, aes(x = ORF_start_percent, fill = factor(Cumulative_ORF_Count))) +
  geom_histogram() +
    scale_fill_hue(l=45)+
  labs(x = "Start positions of ORFs inside of SplitORf transcript in %", y = "Frequency", fill = "Number of ORF inside the SplitORF transcript") +
  theme_minimal()
```
```{r}
ggplot(df_expanded, aes(x = ORF_end_percent, fill = factor(Cumulative_ORF_Count))) +
  geom_histogram() +
    scale_fill_hue(l=45)+
  labs(x = "End positions of ORFs inside of SplitORf transcript in %", y = "Frequency", fill = "Number of ORF inside the SplitORF transcript") +
  theme_minimal()
```
