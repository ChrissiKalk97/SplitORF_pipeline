...
for unique_region in uniquefile:
    ...
    temp=[unique_ids[0],unique_info[1],unique_info[2],unique_ids[1],unique_ids[2],unique_ids[3]]
...
with open(sys.argv[2],'w') as f:
    for i in uniquelist:
        ...
        if 3 * int(i[2]) + int(i[4]) == int(i[5]) - 3:
            ...
            f.write(i[0] + "\t" + str(3 * int(i[1]) + int(i[4])) + "\t" + str(3 * int(i[2]) + int(i[4]) + 3 ) + "\t" + i[3] +  ":" + i[4] + ":" + i[5] + "\n")
        else:
            f.write(i[0] + "\t" + str(3 * int(i[1]) + int(i[4])) + "\t" + str(3 * int(i[2]) + int(i[4])) + "\t" + i[3] +  ":" + i[4] + ":" + i[5] + "\n")