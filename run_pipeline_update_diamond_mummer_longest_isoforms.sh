...
mummer -maxmatch -l 8 $longest_proteins ./Output/run_$timestamp/OrfProteins.fa > ./Output/run_$timestamp/Proteins_maxmatch_l8.mums
...
source ./Genomic_scripts/GetGenomicRegions.sh $genomicpositions $exonpositionsCorrect ./Output/run_$timestamp/Unique_DNA_Regions_gt20_filtered.bed ./Output/run_$timestamp/Unique_Protein_Regions_gt8_valid_filtered.bed ./Output/run_$timestamp/Valid_ORF_Proteins.bed
...
bedtools intersect -a ./Output/run_$timestamp/Unique_DNA_Regions_gt20_genomic_with_trID.bed -b ./Output/run_$timestamp/Unique_Protein_Regions_gt8_valid_genomic_with_trID.bed > ./Output/run_$timestamp/Unique_Regions_Overlap.bed
