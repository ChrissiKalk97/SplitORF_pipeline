...
source ./Bowtie_Align_transcriptomic.sh -i ./Input2023/cDNA_fasta_Ensembl_transcripts_111.fa 10 $outputBowtie/Transcriptomic_Bowtie_index $control $nmd/control_NMD\
...
source ./Bowtie_Align_transcriptomic.sh 10 $outputBowtie/Transcriptomic_Bowtie_index $treatment $nmd/treatment_NMD\
 $nmdmain/Unique_DNA_Regions_for_comparison_filtered_NMD.bed ./Input2023/ExonPositions_correct.bed\
 ./Input2023/Genomic_positions.bed ./Input2023/UTRs_merged_filtered.fa
...
source ./Bowtie_Align_transcriptomic.sh 10 $outputBowtie/Transcriptomic_Bowtie_index $control\
...
ri=$ri/
outputBowtie="./Output/Bowtie_transcriptome_pooled_no_5/"
R -e "rmarkdown::render('RiboSeqReportTranscriptomic.Rmd',output_file='./Output/Bowtie_transcriptome_pooled_no_5/RiboSeqReportTranscriptomic.pdf',params=list(args = c('$outputBowtie', '$nmd','$ri')) ,encoding="UTF-8")"
